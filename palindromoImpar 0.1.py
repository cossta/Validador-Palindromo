...
""" Importando La Libreria del Tiempo """
import time
""" Importando Win32com (Libreria para que hable)"""
...
class todosLosCanvas(object):
    def __init__(self):
        ...
        self.Palabras_P1 = Canvas(root, width=90,height=30)
        self.Palabras_P2 = Canvas(root, width=90,height=30)
    ...
    def pintarIluminadoFlecha2(self):
        pass
    def pintarNormal_Palabras_P1(self):
        self.Palabras_P1.place(x=73,y=160)
        self.Palabras_P1.create_rectangle(0,50,80,0, fill="#2a1a5e")
        self.Palabras_P1.update()
    def pintarIluminado_Palabras_P1(self, datoLeido, datoSacadoDeLaPila):
        self.pintarNormal_Palabras_P1()
        self.pintandoTodo()
        nombreTransicion = str(datoLeido + ", " + datoSacadoDeLaPila + "/"+ datoSacadoDeLaPila + datoLeido)
        self.Palabras_P1.place(x=73,y=160)
        self.Palabras_P1.create_text(40,15,text=nombreTransicion, fill="#f45905",font=("",16))
        self.Palabras_P1.update()
        miFrame.update()
    def pintarNormal_Palabras_P2(self):
        self.Palabras_P2.place(x=243,y=160)
        self.Palabras_P2.create_rectangle(0,50,80,0, fill="#2a1a5e")
        self.Palabras_P2.update()
    def pintarIluminado_Palabras_P2(self, datoLeido):
        self.pintarNormal_Palabras_P2()
        self.pintandoTodo()
        nombreTransicion = str(datoLeido + ", " + datoLeido + "/y")
        self.Palabras_P2.place(x=243,y=160)
        self.Palabras_P2.create_text(40,15,text=nombreTransicion, fill="#f45905",font=("",16))
        self.Palabras_P2.update()
        miFrame.update()    
    ...
    def quitarElementosPila(self, ultimoPilaY, textoApilar):
        ...
        self.PilaLineas.create_text(22, ultimoPilaY, text="b", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="||||", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="ñ", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="w", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="c", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="g", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="h", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="i", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="m", fill="#2a1a5e", font=("",16))
        self.PilaLineas.create_text(22, ultimoPilaY, text="n", fill="#2a1a5e", font=("",16))
...
def VerificarPalindromo(tiempo):
    letraLeida = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","ñ","o","p","q","r","s","t","u","v","w","x","y","z"]
    letraEnLaPila = ["#","a","b","c","d","e","f","g","h","i","j","k","l","m","n","ñ","o","p","q","r","s","t","u","v","w","x","y","z"]
    ...
    palabraMinuscula = Palindro.get()
    pilaPalindromo = palabraMinuscula.lower()
    if len(pilaPalindromo) % 2 == 0:
        misCanvas.pintarIluminadoRojoEstado3()
        speaker.Speak("La Expresión No Es Válida. El Color Rojo Lo Índica")
        return False
    else:
        impar = int((len(pilaPalindromo)/2))
        Palindromo=Pila()
        estado = 1
        entrada = 1
        for i in range(0,len(pilaPalindromo)):
            ...
            if estado == 1:
                ...
                if impar == i and topePila in letraEnLaPila:
                    misCanvas.pintarIluminadoEstado1()
                    misCanvas.pintarNormalFlechaEstado1()
                    Palindromo.apilar(topePila)
                    misCanvas.pintarIluminadoFlecha1()
                    estado = 2
                elif transicion in letraLeida and topePila in letraEnLaPila:
                    Palindromo.apilar(topePila)
                    Palindromo.apilar(transicion)
                    misCanvas.pintarIluminado_Palabras_P1(transicion,topePila)
                    misCanvas.pintarElementosPila(ultimoPilaY,transicion)
                    ultimoPilaY -= 25
                    misCanvas.pintarIluminadoEstado1()
                else:
                    Palindromo.apilar(topePila)
                ...
                if transicion == topePila:
                    if entrada==1:
                        ultimoPilaY -= 25
                        entrada=2
                    misCanvas.quitarElementosPila(ultimoPilaY,transicion)
                    ultimoPilaY += 25
                    misCanvas.pintarIluminado_Palabras_P2(transicion)
                    misCanvas.pintarIluminadoEstado2()
                else:
                    Palindromo.apilar(topePila)
                    misCanvas.pintarIluminadoRojoEstado3()
