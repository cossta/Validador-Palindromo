...
class todosLosCanvas(object):
    ...
    def pintarIluminadoEstado1(self):
        ...
        self.Estado1.update()
    def pintarIluminadoEstado1_NormalFlechaEstado1(self):
        self.Estado1.place(x=50,y=190)
        self.Estado1.create_oval(25,35,100,110, fill="#2a1a5e")
        self.Estado1.create_text(63,75,text="P", fill="#f45905", font=("",24))
        self.Estado1.create_line(32,10,32,50, fill="#2a1a5e", width=3.0)
    ...
    def pintarIluminadoEstado2(self):
        ...
        self.Estado2.update()
    def pintarIluminadoEstado2_NormalFlechaEstado2(self):
        self.Estado2.place(x=220,y=190)
        self.Estado2.create_oval(25,35,100,110, fill="#2a1a5e")
        self.Estado2.create_text(63,75,text="Q", fill="#f45905", font=("",24))
        self.Estado2.create_line(32,10,32,50, fill="#2a1a5e", width=3.0)
    ...
    def pintarIluminadoFlecha2(self):
        self.Flecha2.place(x=321,y=255)
        self.Flecha2.create_line(0,7,100,7, width=3.0, fill="#f45905")
        self.Flecha2.create_line(80,2,90,7, fill="#f45905", width=3.0)
        self.Flecha2.create_line(90,7,80,12, fill="#f45905", width=3.0)
        self.Flecha2.update()
    ...
    def pintarIluminado_Lambda_Numeral(self):
        self.LAMBDA_Numeral.place(x=323,y=220)
        self.LAMBDA_Numeral.create_text(40,15,text="y, #/#", fill="#f45905",font=("",16))
        self.LAMBDA_Numeral.update()
    ...
    for i in range(0,len(pilaPalindromo)):
        ...
        if estado == 1:
            ...
            if transicion=="a" and topePila=="#":
                ...
                misCanvas.pintarIluminadoEstado1_NormalFlechaEstado1()
            ...
            if transicion=="a" and topePila=="a":
                ...
                ultimoPilaY += 25
                misCanvas.pintarIluminado_A_Lambda()
            elif transicion=="b" and topePila=="b":
                if entrada==1:
                    ultimoPilaY -= 25
                    entrada=2
        ...
        time.sleep(tiempo)
    topePila=Palindromo.desapilar()
    if topePila=="#" and len(pilaPalindromo) != 0:
            Palindromo.apilar("#")
            estado = 3
            misCanvas.pintandoTodo()
            misCanvas.pintarIluminado_Lambda_Numeral()
            misCanvas.pintarIluminadoEstado2_NormalFlechaEstado2()
            misCanvas.pintarIluminadoFlecha2()
            time.sleep(tiempo)
    if estado == 3:
        misCanvas.pintandoTodo()
...
LabelPalindromo = Label(miFrame, text="Palindromo Con Pila", font=("Full Pack 2025",12))
