...
"""----------------- Todos los Canvas ----------------------------"""
Estado1 = Canvas(root, width=120, height=120)
Estado2 = Canvas(root, width=120, height=120)
...
def VerificarPalindromo():
    ...
    for i in range(0,len(pilaPalindromo)):
        ...
        if estado == 1:
            Estado1.place(x=50,y=200)
            Estado1.create_oval(25,25,100,100, fill="#2a1a5e")
            Estado1.create_text(63,65,text="P", fill="#f45905", font=("",24))
            ...
            if color==1:
                estadosCanvas()
                color = 2
            Estado2.place(x=220,y=200)
            Estado2.create_oval(25,25,100,100, fill="#2a1a5e")
            Estado2.create_text(63,65,text="Q", fill="#f45905", font=("",24))
            Estado2.update()
...
def estadosCanvas():
    Estado1.place(x=50,y=200)
    Estado1.create_oval(25,25,100,100, fill="#2a1a5e")
    Estado1.create_text(63,65,text="P", fill="#ffffff", font=("",24))
    # Estado1.create_oval(10,35,90,150, fill="#090")
    # Estado1.create_arc(35,10,150,90,extent=110, width=3.0,style=ARC)
    Estado1.update()
    
    Estado2.place(x=220,y=200)
    Estado2.create_oval(25,25,100,100, fill="#2a1a5e")
    Estado2.create_text(63,65,text="Q", fill="#ffffff", font=("",24))
    Estado2.update()
